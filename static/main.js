...
// Load the texture
textureLoader.load('/static/art/space.jpg', (texture) => {
...
// let prince;
// assetLoader.load('/static/art/prince_fox.glb', function(gltf) {
//   prince = gltf.scene;
...
// let rose;
// assetLoader.load('/static/art/rose.glb', function(gltf) {
//   rose = gltf.scene;
...
// let baobab;
// assetLoader.load('/static/art/baobab.glb', function(gltf) {
//   baobab = gltf.scene;
...
// let box;
// assetLoader.load('/static/art/box.glb', function(gltf) {
//   box = gltf.scene;
...
// let sheep;
// assetLoader.load('/static/art/sheep.glb', function(gltf) {
//   sheep = gltf.scene;
...
// let mixer;
// assetLoader.load('/static/art/plane.glb', function(gltf) {
